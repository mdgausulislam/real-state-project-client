...
import React, { useState } from 'react';
import ChatBot from 'react-simple-chatbot';
import { FaCross, FaFacebookMessenger } from 'react-icons/fa';
      ...
      {!botOpen ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
          <ChatBot
            steps={steps}
            handleEnd={handleEnd}
            headerComponent={<button onClick={handleChatIconClick}><FaCross className='w-8 h-8 text-blue-500' /></button>}
          />
        </div>
      )}
    </div>
